...
eventHTMLElem('click', 'd_hardtop', true, function(event) {
  changeVis(['GROUP', 'opt_hardtop'], true);
});
eventHTMLElem('click', 'e_hardtop', true, function(event) {
  changeVis(['GROUP', 'opt_hardtop'], false);
});

eventHTMLElem('click', 'screenshot', true, function(event) {
  downloadFile(appInstance.renderer.domElement.toDataURL('image/png'), 'screenshot.png');
});

/* B Tube pvc light gray */
eventHTMLElem('click', ['e_tube_1', 'd_tube_1', 'tube_1'], true, function(event) {
  setMaterialColor('PVC_base_2_1', 'PVC_base_2_1 Base Color', 0.247, 0.325, 0.354, '');
});
/* Tube pvc black */
eventHTMLElem('click', ['e_tube_2', 'd_tube_2', 'tube_2'], true, function(event) {
  setMaterialColor('PVC_base_2_1', 'PVC_base_2_1 Base Color', 0.01, 0.01, 0.01, '');
});
/* Tube pvc dark gray */
eventHTMLElem('click', ['e_tube_3', 'd_tube_3', 'tube_3'], true, function(event) {
  setMaterialColor('PVC_base_2_1', 'PVC_base_2_1 Base Color', 0.085, 0.096, 0.106, '');
});

/* decor black */
eventHTMLElem('click', ['e_tube-decor_1', 'd_tube-decor_1', 'tube-decor_1'], true, function(event) {
  setMaterialColor('PVC_decor_1_', 'PVC_decor_1_ Base Color', 0.006, 0.006, 0.006, '');
});
/* decor gray */
eventHTMLElem('click', ['e_tube-decor_2', 'd_tube-decor_2', 'tube-decor_2'], true, function(event) {
  setMaterialColor('PVC_decor_1_', 'PVC_decor_1_ Base Color', 0.1, 0.1, 0.1, '');
});
/* decor white */
eventHTMLElem('click', ['e_tube-decor_3', 'd_tube-decor_3', 'tube-decor_3'], true, function(event) {
  setMaterialColor('PVC_decor_1_', 'PVC_decor_1_ Base Color', 0.8, 0.8, 0.8, '');
});
